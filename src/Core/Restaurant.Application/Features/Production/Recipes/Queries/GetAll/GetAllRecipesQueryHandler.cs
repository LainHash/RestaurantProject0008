...
{
    internal class GetAllRecipesQueryHandler : IRequestHandler<GetAllRecipesQuery, PageResult<IEnumerable<RecipeResponse>>>
    {
        ...
        public async Task<PageResult<IEnumerable<RecipeResponse>>> Handle(GetAllRecipesQuery request, CancellationToken cancellationToken)
        {
